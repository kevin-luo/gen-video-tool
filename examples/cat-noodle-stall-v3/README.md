...
- WanGP 为每个镜头保留两个固定 seed，按需一次生成一个 49 帧快速源片，并确定性重采样为 81 帧项目候选；
- 人工审片后选择候选；
...
最终 MP4 为 23.5667 秒、1080×1920、30 fps、707 帧，SHA-256 为 `620ba1b42e9f134262b828ee1167b11910ffec94822574d1497c82cbb9b6489b`。
